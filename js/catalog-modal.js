...
const openModal = (e) => {
    ...
    if (e.value === '1') {
        ...
        cardText = `
                    ...
                    <ul class="modal__list">
                        <li class="modal__item">
                            <p class="modal__item-text"><span class="modal__item-title">Площадь:</span>85&nbsp;кв.&nbsp;м</p>
                        </li>
                        <li class="modal__item">
                            <p class="modal__item-text"><span class="modal__item-title">Этажи:</span>3-й этажи</p>
                        </li>
                        <li class="modal__item">
                            <p class="modal__item-text"><span class="modal__item-title">Комнаты:</span>3&nbsp;(гостиная, 2&nbsp;спальни)</p>
                        </li>
                        <li class="modal__item">
                            <p class="modal__item-text"><span class="modal__item-title">Высота потолков:</span>3,8 м</p>
                        </li>
                        <li class="modal__item">
                            <p class="modal__item-text"><span class="modal__item-title">вид на&nbsp;Набережную реки Фонтанка и&nbsp;зеленую зону комплекса</p>
                        </li>
                    </ul>
                </div>
                <div class="modal__about">
                    ...
                    <p class="modal__item-text">
                        Апартаменты &laquo;Nice Loft&raquo; отличаются продуманной планировкой и&nbsp;стильным интерьером, который сочетает индустриальный дизайн и&nbsp;современные решения. Пространство оптимизировано для максимального комфорта и&nbsp;функциональности.                    
                    </p>
                    <ul class="modal__list">
                        <li class="modal__item">
                            <p class="modal__item-text"><span class="modal__item-title">Гостиная:</span>просторная зона для отдыха и&nbsp;приема гостей (30&nbsp;кв.&nbsp;м), соединенная с&nbsp;обеденной зоной</p>
                        </li>
                        <li class="modal__item">
                            <p class="modal__item-text"><span class="modal__item-title">Кухня:</span>открытая кухня (12&nbsp;кв.&nbsp;м) с&nbsp;барной стойкой и&nbsp;современной бытовой техникой (Bosch, Electrolux)</p>
                        </li>
                        <li class="modal__item">
                            <p class="modal__item-text"><span class="modal__item-title">Спальни:</span>
                                <ul>
                                    <li>Главная спальня: 20&nbsp;кв.&nbsp;м&nbsp;с&nbsp;гардеробной и&nbsp;отдельной ванной комнатой (6&nbsp;кв.&nbsp;м)</li>
                                    <li>Вторая спальня: 15&nbsp;кв.&nbsp;м, идеально подходящая для детской комнаты или кабинета</li>
                                </ul>
                            </p>
                        </li>
                        <li class="modal__item">
                            <p class="modal__item-text"><span class="modal__item-title">Ванная комната:</span>7&nbsp;кв.&nbsp;м&nbsp;с&nbsp;современной сантехникой и&nbsp;стильной отделкой</p>
                        </li>
                        <li class="modal__item">
                            <p class="modal__item-text"><span class="modal__item-title">Балкон:</span>5&nbsp;кв.&nbsp;м&nbsp;с&nbsp;видом на&nbsp;зеленую зону комплекса, оборудован для комфортного отдыха</p>
                        </li>
                    </ul>
                </div>
                <div class="modal__about">
                ...
                <div class="modal__about">
                    ...
                    <p class="modal__item-text">35&nbsp;000&nbsp;000&nbsp;рублей</p>
                </div>
        `;
    } else if (e.value === '3') {
